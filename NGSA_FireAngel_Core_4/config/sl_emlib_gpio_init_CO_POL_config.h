#ifndef SL_EMLIB_GPIO_INIT_CO_POL_CONFIG_H
#define SL_EMLIB_GPIO_INIT_CO_POL_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_CO_POL_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_CO_POL_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_CO_POL_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_CO_POL_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_CO_POL
// $[GPIO_SL_EMLIB_GPIO_INIT_CO_POL]
#define SL_EMLIB_GPIO_INIT_CO_POL_PORT           gpioPortA
#define SL_EMLIB_GPIO_INIT_CO_POL_PIN            7
// [GPIO_SL_EMLIB_GPIO_INIT_CO_POL]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_CO_POL_CONFIG_H
